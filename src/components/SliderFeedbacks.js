...
import SwiperCore, { Navigation, Pagination, EffectCoverflow,GrabCursor,CenteredSlides,Loop } from "swiper";
...
function SliderFeedbacks() {
    // check if the window width is smaller than 990px to make the slider responsive
  ...
  return (
      <div className="swiper">
        <Swiper className="d-flex row col-md-12"
        navigation
        initialSlide={2}
        ...
        centeredSlides
        >
            <SwiperSlide className='slider-card feedback-card p-5' style={{zIndex:"1", fontSize:".8rem"}}>
                <svg className='feedback-mark' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="33.992" height="42.163" viewBox="0 0 33.992 42.163">
                    <defs>
                ...
                <div className='justify-content-center text-center'>
                    <p style={{fontWeight:"300"}}>"هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص"</p>
                    <svg className='mx-auto row feedback-stars' xmlns="http://www.w3.org/2000/svg" width={94} height={13}>
                    <defs>
                    <linearGradient
                        id="b"
                        x1={0.091}
                ...
                <div className='d-flex row col-12 feedback-info justify-content-center align-items-center'>
                    <div className='col-2 feedback-flag d-flex justify-content-center align-items-center'>
                    ...
                    <div className='col-8 col p-2'>
                        <p className='feedback-name m-0 mb-2' style={{fontWeight:"400", color:"#4A4A4A"}}>دكتور محمد</p>
                        <span className='row feedback-comment m-0' style={{fontWeight:"300", color:"#707070"}}>نص يعبر عن وظيفة صاحب التعليق مكونة من سطر او يقل</span>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide className='slider-card feedback-card p-5' style={{zIndex:"1", fontSize:".8rem"}}>
