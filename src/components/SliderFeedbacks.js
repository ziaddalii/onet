...
export default class SliderFeedbacks extends Component {
  render() {
    const settings = {
      className: "center",
      dots:true,
    ...
    return (
      <div>
        <Slider {...settings}>
        <div className='feedback-card p-5' style={{maxHeight:"153px", zIndex:"1", fontSize:".8rem"}}>
        ...
        <div className='justify-content-center text-center'>
            ...
            <svg className='mx-auto feedback-stars' xmlns="http://www.w3.org/2000/svg" width={94} height={13}>
            <defs>
            <linearGradient
                id="b"
                x1={0.091}
        ...
        <div className='d-flex col-md-12 feedback-info justify-content-center align-items-center'>
            <div className='col-md-2 feedback-flag d-flex justify-content-center align-items-center'>
            ...
            <div className='col-md-10 col p-2'>
                <p className='row feedback-name m-0 mb-2' style={{fontWeight:"400", color:"#4A4A4A"}}>دكتور محمد</p>
    ...
    <div className='feedback-card p-5' style={{maxHeight:"290px", zIndex:"1", fontSize:".8rem"}}>
    <svg className='feedback-mark' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="33.992" height="42.163" viewBox="0 0 33.992 42.163">
        <defs>
            <linearGradient id="linear-gradient" x1="0.5" y1="1" x2="0.5" gradientUnits="objectBoundingBox">
            <stop offset="0" stopColor="#ff9133"/>
