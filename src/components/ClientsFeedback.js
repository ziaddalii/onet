...
function ClientsFeedback() {
  return (
    <div className='row w-100 text-color m-0' style={{backgroundColor:"#FBF9FE", position:"relative", overflow:"hidden"}}>
        ...
        <div className='w-75 mx-auto px-0' style={{margin:"82px", overflow:'visible'}}>
            <div className='section d-flex align-items-center justify-content-center' style={{marginBottom:"45px", }}>
                <p className='text-color' style={{fontWeight:"500",fontSize:"42px", zIndex:"10"}}>اراء العملاء</p>
            </div>
            <div className='col-md-12 row justify-content-center m-0'>
                
                <div className='p-0 col-md-12 row d-flex justify-content-center align-items-center' style={{position:"relative", margin:"160px 0"}}>
                    <div className='clients-feedback-overlay'></div>

                    <div className='clients-feedback-circle-overlay col-12'>
                    <svg className='overlay-circle1-flag-position-1' xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
                    <g id="Group_1539" data-name="Group 1539" transform="translate(-967 -832)">
                    ...
                    <svg className="overlay-circle1-flag-position-2" xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
                    ...
                    <div className='clients-feedback-circle-overlay2 col-12'>
                        <svg className='overlay-circle2-flag-position-1' xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
                        ...
                        <svg className='overlay-circle2-flag-position-2' xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
                        ...
                        <svg className='overlay-circle2-flag-position-3' xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
                        ...
                        <svg className='overlay-circle2-flag-position-4' xmlns="http://www.w3.org/2000/svg" width="44" height="30" viewBox="0 0 44 30">
